...
function montoTotal (v: vector; dL, pos: integer): real;
begin
	if (pos > dL) then
		montoTotal := 0
	else
		montoTotal := v[pos].expensas + montoTotal (v, dL, pos + 1);
end;
...
begin
	...
	pos := 1;
	writeln ('El monto total de las expensas es: ', montoTotal (v, dL, pos):2:2);
end.

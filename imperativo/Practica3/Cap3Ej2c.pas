...
function modulo2C (a2: arbol2): integer;
var
	maxAuxiliar: integer;
begin
	maxAuxiliar := 0;
	if (a2 <> nil) then
		begin
			if (a2^.dato.cantidadTotal > maxAuxiliar) then
				modulo2C := a2^.dato.codigo;
			modulo2C := modulo2C (a2^.HI);
			modulo2C := modulo2C (a2^.HD);
		end;
end;
...
begin
	...
	writeln ('---------------');
	writeln ('El codigo de producto con mayor cantidad total de unidades vendidas es: ', modulo2C (a2));
end.
